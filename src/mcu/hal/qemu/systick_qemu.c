/**
 * @file systick_qemu.c
 * @brief SysTick driver for QEMU MPS2-AN505
 *
 * The MPS2-AN505 SysTick works correctly in QEMU, so this is mostly
 * the same as the STM32 version but uses the MPS2 clock rate.
 */
...
void systick_init(void)
{
     ...
     * MPS2-AN505 runs at 25 MHz system clock */
