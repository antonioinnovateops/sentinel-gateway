/**
 * @file startup_mps2_an505.s
 * @brief Startup code for MPS2-AN505 Cortex-M33 (QEMU)
 *
 * Vector table + Reset_Handler that:
 * 1. Copies .data from flash to RAM
 * 2. Zeros .bss
 * 3. Calls qemu_hal_shim_init()
 * 4. Calls main()
 */
...
g_pfnVectors:
    ...
    .word SecureFault_Handler  /* Secure fault (M33 specific) */
    .word 0                    /* Reserved */
    .word 0                    /* Reserved */
    .word 0                    /* Reserved */
    ...
    /* IRQ handlers (simplified — first 96 for AN505) */
    .rept 96
...
Reset_Handler:
    /* Set stack pointer explicitly (some QEMU versions need this) */
    ldr r0, =_estack
    msr msp, r0
...
.zero_bss_check:
    ...
    /* Initialize QEMU HAL shim */
    bl qemu_hal_shim_init
...
Default_Handler:
    ...
    /* SysTick_Handler is defined in systick_qemu.c — NOT weak here */
